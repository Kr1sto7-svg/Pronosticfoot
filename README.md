...
- (Pour l'onglet Live) une clé **API-Football** gratuite (100 req/jour) : api-football.com.
...
3. Settings > Environment Variables : ajouter `APIFOOTBALL_KEY` (et éventuellement `FOOTBALLDATA_TOKEN`).
...
vercel env add APIFOOTBALL_KEY
vercel --prod
```
...
## Le proxy `/api/stats`
- `GET /api/stats?source=apifootball&league=61&season=2023`
